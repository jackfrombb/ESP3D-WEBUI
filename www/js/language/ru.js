...
var russiantrans = {
    ...
    "ESP3D for": "ESP3D для",
    "Attention": "Внимание",
    "The file has been renamed with 8.3 filename convention: " : "Файл был переименован в соответствии с системой имен 8.3",
    ...
    "Connection failed! is your FW correct?": "Соединение не удалось! Проверьте правильность прошивки",
    "Controls": "Управление",
    ...
    "error:4": "Возвращено отрицательное значение вместо положительного.",
    "error:5": "Ошибка установки нулевой точки. Установка нулевой точки отключена в настройках.",
    "error:6": "Минимальное время импульса шага должно быть больше, чем 3usec.",
    ...
    "error:13": "Безопасная дверь открыта и состояние двери инициировано.",
    "error:14": "Информация о сборке или строка запуска превысили ограничение по длине строки EEPROM. Строка не сохранена.",
    ...
    "error:27": "Значение номера строки недопустимо.",
    "error:28": "В команде G-code отсутствует требуемое значение.",
