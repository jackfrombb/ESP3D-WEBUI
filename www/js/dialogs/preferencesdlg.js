...
function initpreferences() {
    ...
    if (supportsRedundantTemperatures())
        document.getElementById('redundant_controls_option').style.display = 'block';
...
function prefs_toggledisplay(id_source, forcevalue) {
    ...
    switch (id_source) {
        ...
        case 'show_temperatures_panel':
            if (document.getElementById(id_source).checked)
                document.getElementById("temperatures_preferences").style.display = "block";
        ...
        case 'show_grbl_probe_tab':
            if (document.getElementById(id_source).checked)
                document.getElementById("grbl_probe_preferences").style.display = "block";
...
function applypreferenceslist() {
    ...
    translateText(preferenceslist[0].language);
    ...
    const IS_LOCK_ENABLED = preferenceslist[0].enable_lock_UI === 'true';
    NAV_BAR.setLockUiBtnVisible(IS_LOCK_ENABLED);
    NAV_BAR.lockUi_onToggleLock(IS_LOCK_ENABLED);
...
function build_dlg_preferences_list() {
    ...
    content += buildLanguageList("language_preferences");
    content += "</td></tr></table>";
    ...
    if (typeof(preferenceslist[0].camera_address) !== 'undefined') {
        document.getElementById('preferences_camera_webaddress').value = decodeEntities(preferenceslist[0].camera_address);
...
function closePreferencesDialog() {
    ...
    if (preferenceslist[0].length != 0) {
        ...
        if ((typeof(preferenceslist[0].language) === 'undefined') ||
            ...
            //camera address
            if (document.getElementById('preferences_camera_webaddress').value != decodeEntities(preferenceslist[0].camera_address)) modified = true;
            //DHT
    ...
    if (modified) {
        confirmdlg(translateTextItem("Data modified"), translateTextItem("Do you want to save?"), process_preferencesCloseDialog)
    } else {
        closeModal('cancel');
    }
}
...
function SavePreferences(current_preferences) {
    if (http_communication_locked) {
        alertdlg(translateTextItem("Busy..."),
            translateTextItem("Communications are currently locked, please wait and retry."));
        return;
    }
...
function preferencesUploadfailed(errorcode, response) {
    alertdlg(translateTextItem("Error"), translateTextItem("Save preferences failed!"));
}
...
function Checkvalues(id_2_check) {
    ...
    switch (id_2_check) {
        ...
        case "preferences_pos_Interval_check":
            ...
            if (!(!isNaN(value) && value >= 1 && value <= 100)) {
                error_message = translateTextItem("Value of auto-check must be between 0s and 99s !!");
                status = false;
            }
            break;
        case "preferences_control_xy_velocity":
            ...
            if (!(!isNaN(value) && value >= 1)) {
                error_message = translateTextItem("XY Feedrate value must be at least 1 mm/min!");
                status = false;
            }
            break;
        case "preferences_control_z_velocity":
            value = parseInt(document.getElementById(id_2_check).value);
            if (!(!isNaN(value) && value >= 1)) {
                error_message = translateTextItem("Z Feedrate value must be at least 1 mm/min!");
                status = false;
            }
            break;
        ...
        case "preferences_control_c_velocity":
            value = parseInt(document.getElementById(id_2_check).value);
            if (!(!isNaN(value) && value >= 1)) {
                error_message = translateTextItem("Axis Feedrate value must be at least 1 mm/min!");
                status = false;
            }
            break;
        case "preferences_tempInterval_check":
        ...
        case "preferences_e_velocity":
            ...
            if (!(!isNaN(value) && value >= 1 && value <= 9999)) {
                error_message = translateTextItem("Value of extruder velocity must be between 1 mm/min and 9999 mm/min !");
                status = false;
            }
            break;
        case "preferences_probefeedrate":
            value = parseInt(document.getElementById(id_2_check).value);
            if (!(!isNaN(value) && value >= 1 && value <= 9999)) {
                error_message = translateTextItem("Value of probe feedrate must be between 1 mm/min and 9999 mm/min !");
                status = false;
            }
            break;
        case "preferences_probemaxtravel":
            value = parseInt(document.getElementById(id_2_check).value);
            if (!(!isNaN(value) && value >= 1 && value <= 9999)) {
                error_message = translateTextItem("Value of maximum probe travel must be between 1 mm and 9999 mm !");
                status = false;
            }
            break;
        case "preferences_probetouchplatethickness":
            ...
            if (!(!isNaN(value) && value >= 0 && value <= 9999)) {
                error_message = translateTextItem("Value of probe touch plate thickness must be between 0 mm and 9999 mm !");
                status = false;
            }
            break;
        case "preferences_surfacewidth":
            value = parseFloat(document.getElementById(id_2_check).value);
            if (!(!isNaN(value) && value >= 1 && value <= 9999)) {
                error_message = translateTextItem("Value of surface width must be between 1 mm and 9999 mm !");
                status = false;
            }
            break;
        case "preferences_surfacelength":
            value = parseFloat(document.getElementById(id_2_check).value);
            if (!(!isNaN(value) && value >= 1 && value <= 9999)) {
                error_message = translateTextItem("Value of surface length must be between 1 mm and 9999 mm !");
                status = false;
            }
            break;
        case "preferences_surfacezdepth":
            value = parseFloat(document.getElementById(id_2_check).value);
            if (!(!isNaN(value) && value >= 0 && value <= 100)) {
                error_message = translateTextItem("Value of surface Zdepth must be between 0 mm and 100 mm !");
                status = false;
            }
            break;
        case "preferences_surfacebitdiam":
            value = parseFloat(document.getElementById(id_2_check).value);
            if (!(!isNaN(value) && value >= 0 && value <= 9999)) {
                error_message = translateTextItem("Value of bit diameter for surfacing must be between 0.1 mm and 999 mm !");
                status = false;
            }
            break;
        case "preferences_surfacespindle":
            ...
            if (!(!isNaN(value) && value >= 1000 && value <= 50000)) {
                error_message = translateTextItem("Value of surfacing spindle RPM must be between 1000 mm and 50000 mm !");
                status = false;
            }
            break;
        case "preferences_surfacefeedrate":
            ...
            if (!(!isNaN(value) && value >= 100 && value <= 10000)) {
                error_message = translateTextItem("Value of surfacing feedrate must be between 100 mm/min and 10000 mm/min !");
                status = false;
            }
            break;
        case "preferences_surfacestepover":
            ...
            if (!(!isNaN(value) && value >= 10 && value <= 90)) {
                error_message = translateTextItem("Value of surfacing stepover must be between 10 % and 90 % !");
                status = false;
            }
            break;
        case "preferences_filament_length":
            ...
            if (!(!isNaN(value) && value >= 0.001 && value <= 9999)) {
                error_message = translateTextItem("Value of filament length must be between 0.001 mm and 9999 mm !");
                status = false;
            }
            break;
        case "preferences_filters":
            ...
            if ((value.indexOf(".") != -1) ||
                (value.indexOf("*") != -1)) {
                error_message = translateTextItem("Only alphanumeric chars separated by ; for extensions filters");
                status = false;
            }
            break;
    }
    if (status) {
        ...
        document.getElementById(id_2_check + "_icon").innerHTML = getIconSvg("remove");
        alertdlg(translateTextItem("Out of range"), error_message);
    }
    return status;
}
