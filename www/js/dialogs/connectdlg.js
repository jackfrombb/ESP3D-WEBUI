...
function getFWdata(response) {
    ...
    if (async_webcommunication) {
        if (!!window.EventSource) {
            ...
            event_source.addEventListener('InitID', initEvents, false);
            event_source.addEventListener('ActiveID', activeIdEvents, false);
            event_source.addEventListener('DHT', dhtEvents, false);
        }
    }
